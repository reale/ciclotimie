...
\pgfmathsetmacro\TotalPageCount{106}% Must be manually entered
...
\def\PrintISBN{979-12-200-8659-2}%
\def\PrintISBNShort{12-200-8659-2}%
%\def\HardcoverISBN{979-12-200-1682-7}%
%\def\HardcoverISBNShort{12-200-1682-7}%  
\def\EbookISBN{979-12-200-8660-8}%
\def\EbookISBNShort{12-200-8660-8}%
...
%% ----------------------------------------------------------------------------
\def\TheCopyrightKeywords{1. Poetry}

\def\ShortDescription{% Normally restricted to 300 t0 350 characters depending on publisher.
    \textsf{\textbf{Ciclotimie} è una raccolta di frammenti scritti negli anni 2010-16.}}

\def\BackDescription{% Typically max 2000-4000 characters
    \textsf{\textbf{Ciclotimie} è una raccolta di frammenti scritti negli anni 2010-16.}}

\def\AuthorBio{% 
    \textsf{\textbf{Roberto Reale} ha già pubblicato \emph{Canti popolari della Penisola Sorrentina}, \emph{Mediterranea} e \emph{Déchargement}. Di giorno si occupa di innovazione e trasformazione digitale.}}
